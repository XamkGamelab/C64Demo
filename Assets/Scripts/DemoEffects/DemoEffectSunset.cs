...
public class DemoEffectSunset : DemoEffectBase
{
    ...
    private float steerSpeedMax = 1f;
    private float steerSpeedCurrent = 0f;
    ...
    public override DemoEffectBase Init()
    {
        ...
        sunRenderer = TextureAndGaphicsFunctions.InstantiateSpriteRendererGO("Sun", new Vector3(0, 0.64f, 1f), "Sunset/SunsetSun");
        AddToGeneratedObjectsDict(sunRenderer.gameObject.name, sunRenderer.gameObject);

        mountainRenderer = TextureAndGaphicsFunctions.InstantiateSpriteRendererGO("Mountains", new Vector3(0, 0, 1f), "Sunset/SunsetMountains");
        ...
        imgLogoTxtSS = TextureAndGaphicsFunctions.InstantiateSpriteRendererGO("LogoTxtSS", new Vector3(0.64f, 0.64f, 1f), "Sunset/SunsetTextSS");
        AddToGeneratedObjectsDict(imgLogoTxtSS.gameObject.name, imgLogoTxtSS.gameObject);

        imgLogoTxtOverride = TextureAndGaphicsFunctions.InstantiateSpriteRendererGO("LogoTxtOverride", new Vector3(0.64f, 0.48f, 1f), "Sunset/SunsetTextOverride");
    ...
    private void Steer(Vector2 input)
    {
        ...
        mountainRenderer.material.SetVector("_ScrollSpeed", new Vector4(input.x * steerSpeedMax, 0, 0, 0));
    }
}
